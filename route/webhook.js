...
function webhook(req, res) {
  ...
  // req log
  __logger.info('webhook()');
  __logger.debug('request :', req.body);
  __logger.debug('source : ', res.locals.source);
  __logger.debug('message : ', res.locals.message);
...
function commandHandler(req, res) {
  ...
  __logger.debug('commandHandler(): cmd =', cmd);
